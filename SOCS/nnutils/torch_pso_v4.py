...
class Particle:
    ...
    def __init__(
        ...
        while(1):
            ...
            init_scale=np.linalg.norm(init_scale,axis=0,keepdims=True)
            if self.check_pose(delta_euler,init_t,init_scale):
        ...
        speed_s=np.random.uniform(-max_scale_speed, max_scale_speed,size=(1))
    ...
    def clamp_speed(self,speed_ts):
        ...
        clamped_speed_ts[3:4]=speed_ts[3:4].clip(-self.max_scale_speed,self.max_scale_speed)
...
class PSO:
    ...
    def __init__(
        ...
        self.Particle_list = [
            Particle(surface_points=self.surface_points,init_R=self.init_R) for _ in range(size)]
    ...
    def update_speed(self,part):
        ...
        speed_s = self.w * part.speed_ts[3:4] \
